...
contract TronFiber {
    ...
    function contractInfo() view external returns(uint256 _invested, uint256 _withdrawn, uint256 _match_bonus, uint _launch_date) {
        return (invested, withdrawn, match_bonus, launch_date);
    }
}